// creates 400 x 600 canvas for pong game with "canvas" reference
const canvas = document.getElementById('canvas');
/* get a "context". Without "context", we can't draw on canvas */
const ctx = canvas.getContext('2d');
  
//variable declarations for measuremnts
const netWidth = 4;
...
// objects in the game: setting net, user, ai, and ball's location, size, and color
const net = {
